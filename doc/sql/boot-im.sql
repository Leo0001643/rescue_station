...
CREATE TABLE `loan_apply` (
                              ...
                              `chat_id` varchar(80) DEFAULT NULL COMMENT '账号ID',
                              `billno` varchar(60) DEFAULT NULL COMMENT '申请单号',
                              ...
                              KEY `chat_id_index` (`chat_id`),
                              FULLTEXT KEY `full_text_username` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='贷款申请表';


CREATE TABLE `marquee_info` (
                                `id` bigint NOT NULL COMMENT '主键',
                                `content` varchar(60) DEFAULT NULL COMMENT '广播信息',
                                `status` int NOT NULL COMMENT '状态',
                                `create_time` datetime DEFAULT NULL COMMENT '添加时间',
                                PRIMARY KEY (`id`),
                                KEY `create_time_index` (`create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='广播信息表';
